...
namespace MiktoGames
{
    public class Viewpoint : MonoBehaviour
    {
        ...
        [Space, SerializeField, Range(0f, 100)] private float _maxViewRange = 8;
        [SerializeField, Range(0f, 100)] private float _maxTextViewRange = 3;
        ...
        void Update()
        {
            if (_imageUI == null || _imageText == null) return;
            ...
            Color textColor = _imageText.color;
            textColor.a = Mathf.Lerp(textColor.a, _distance < _maxTextViewRange ? 1f : 0f, 10 * Time.deltaTime);
            _imageText.color = textColor;

            Color imgColor = _imageUI.color;
            imgColor.a = Mathf.Lerp(imgColor.a, _distance < _maxViewRange ? 1f : 0f, 10 * Time.deltaTime);
            _imageUI.color = imgColor;
        }
